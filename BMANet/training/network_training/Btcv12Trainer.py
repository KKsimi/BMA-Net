...
from bmanet.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
from bmanet.training.loss_functions.dice_loss import DC_and_CE_loss
from bmanet.training.network_training.Btcv12_basetrainer import Btcv12_basetrainer
...
class Btcv12Trainer(Btcv12_basetrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(Btcv12Trainer, self).__init__(deterministic, fp16)
    ...
    def initialize_network(self):
        ...
        self.network = HmsUnet(num_classes=13, spatial=3)
    ...
    def run_training(self):
        ...
        super(Btcv12Trainer, self).run_training()
    ...
    def preprocess_patient(self, input_files):
        ...
        preprocessor_class = recursive_find_python_class([join(bmanet.__path__[0], "preprocessing")],
                                                         preprocessor_name,
                                                         current_module="bmanet.preprocessing")
        assert preprocessor_class is not None, "Could not find preprocessor %s in bmanet.preprocessing" % \
                                               preprocessor_name
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True, step_size: float = 0.5,
        ...
        if run_postprocessing_on_folds:
            # in the old bmanet we would stop here. Now we add a postprocessing. This postprocessing can remove everything
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(Btcv12Trainer, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
