...
from bmanet.inference.segmentation_export import save_segmentation_nifti_from_softmax
...
class nnUNetTrainerV2_fullEvals(nnUNetTrainerV2):
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True,
        ...
        """
        disable bmanet postprocessing. this would just waste computation time and does not benefit brats
