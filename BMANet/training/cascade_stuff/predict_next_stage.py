...
import argparse
from bmanet.preprocessing.preprocessing import resample_data_or_seg
...
if __name__ == "__main__":
    ...
    trainer_class = recursive_find_python_class([join(bmanet.__path__[0], "training", "network_training")],
                                                trainerclass,
                                                "bmanet.training.network_training")

    if trainer_class is None:
        raise RuntimeError("Could not find trainer class in bmanet.training.network_training")
    else:
