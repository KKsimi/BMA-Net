...
from bmanet.inference.segmentation_export import save_segmentation_nifti_from_softmax, save_segmentation_nifti
...
from bmanet.postprocessing.connected_components import load_remove_save, load_postprocessing
from bmanet.training.model_restore import load_model_and_checkpoint_files
from bmanet.utilities.one_hot_encoding import to_one_hot
...
def predict_cases(model, list_of_lists, output_filenames, folds, save_npz, num_threads_preprocessing,
                  ...
                  overwrite_existing=False,                                         # model_best
                  all_in_gpu=False, step_size=0.5, checkpoint_name="model_best",# model_best model_final_checkpoint
...
def predict_from_folder(model: str, input_folder: str, output_folder: str, folds: Union[Tuple[int], List[int]],
                        ...
                        step_size: float = 0.5, checkpoint_name: str = "model_best",  # model_latest  model_best model_final_checkpoint
                        segmentation_export_kwargs: dict = None, disable_postprocessing: bool = False):
    """
