...
import bmanet
from bmanet.paths import network_training_output_dir, preprocessing_output_dir, default_plans_identifier
from batchgenerators.utilities.file_and_folder_operations import *
from bmanet.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(bmanet.__path__[0], "training", "network_training"),
                              base_module='bmanet.training.network_training'):
    ...
    plans['plans_per_stage'][Stage]['patch_size'] = np.array([32,128,128])
    plans['plans_per_stage'][Stage]['pool_op_kernel_sizes'] = [[1, 2, 2], [1, 2, 2], [2, 2, 2],[2, 2, 2]]
